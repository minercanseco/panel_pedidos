...
class ControladorSaldarCartera:
    ...
    def _normaliza_formas_pago(self, forma_pago):
        ...
        return formas_pago.get(forma_pago, '99')
    ...
    def _llamar_popup_saldado(self, parametros_de_saldado):
        ...
        instancia = SaldarDocumentos(
            nueva_ventana,
            self._parametros,
            self._base_de_datos,
            parametros_de_saldado
        )
