...
class ControladorVerificador:
    ...
    def _consolidar_info_productos_seleccionado(self, product_id, precios):
        ...
        if ofertado:
            ...
            totales = self._utilerias.calcular_totales_partida(precio_previo, cantidad, tax_type_id, clave_unidad, clave_sat)
            totales_oferta = self._utilerias.calcular_totales_partida(precio_oferta, cantidad, tax_type_id, clave_unidad, clave_sat)
            ...
            clave_unidad =  info_producto['ClaveUnidad']
            clave_sat = info_producto['ClaveProdServ']
            totales = self._utilerias.calcular_totales_partida(precios['precio'],
                                                               cantidad,
                                                               tax_type_id,
                                                               clave_unidad,
                                                               clave_sat)
