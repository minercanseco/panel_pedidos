...
from capturar_documento.herramientas.cobro_rapido.editar_cobro import EditarCobros
from capturar_documento.herramientas.cobro_rapido.registro_vouchers import RegistroVouchers
