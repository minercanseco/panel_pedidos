...
class EditarPartida:
    ...
    def _respaldar_edicion_con_historial(
        ...
        # items_extra conserva un solo respaldo por partida. La bitacora del
        # pedido ya registra el cambio al guardar, por lo que el comentario de
        # auditoria debe reemplazar al anterior en vez de concatenarlo.
