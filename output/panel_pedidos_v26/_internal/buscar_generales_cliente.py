...
class BuscarGeneralesCliente:
    ...
    def _buscar_cliente(self, event=None):
        ...
        if not termino_buscado:
            ...
            if not nombres_clientes:
                ...
                ttkbootstrap.dialogs.Messagebox.show_error('No se encontraron resultados.')
            else:
    ...
    def _seleccionar_cliente(self):
        ...
        if not seleccion:
            ttkbootstrap.dialogs.Messagebox.show_error('Debe buscar y seleccionar un cliente.')
            ...
            if self._cliente.depots > 0:
                ...
                if seleccion_direccion == 'DIRECCIÓN FISCAL' or not seleccion_direccion:
                    respuesta = ttk.dialogs.Messagebox.yesno('El cliente tiene sucursales '
    ...
    def _documento_seleccionado(self):
        ...
        if self._cliente.cayal_customer_type_id in (0, 1):
            ...
            if seleccion == 'Seleccione':
                ttkbootstrap.dialogs.Messagebox.show_error('Debe seleccionar un tipo de documento.')
                return False
